...
| `/po close-sprint <sprint-number>` | Release Manager | sprint # | sprint issues closed (`sprint-completed`), story branches deleted, release PRs to main, migrations flagged |
