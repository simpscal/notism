...
create_label "story-deferred"       "Story deferred to next sprint"              "f9d0c4"
create_label "requirement-updated"  "Requirement updated after change"           "fef2c0"
create_label "design-updated"       "Design instructions updated after change"   "e99695"
create_label "technical-updated"    "TDD updated after change"                   "c5def5"
create_label "skill:frontend"       "Frontend skill tag"                         "f9d0c4"
create_label "skill:backend"        "Backend skill tag"                          "c5def5"
create_label "skill:devops"         "DevOps skill tag"                           "ededed"
